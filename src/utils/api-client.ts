...
> extends HttpClient<SecurityDataType> {
	...
	auth = {
		...
		sendCodeAuthSendCodePost: (
			data: RequestVerifyCodeInputDTO,
			params: RequestParams = {}
		) =>
	...
	adventures = {
		 ...
		 * @secure
		 */
		createAdventuresCreatePost: (
			data: CreateAdventureInputDTO,
			params: RequestParams = {}
		) =>
			this.request<AdventureDTO, HTTPValidationError>({
		 ...
		 * @secure
		 */
		inviteAdventuresInvitePost: (
			data: InviteToAdventureInputDTO,
			params: RequestParams = {}
		) =>
			this.request<PlayersByAdventureOutputDTO, HTTPValidationError>({
		 ...
		 * @secure
		 */
		deleteAdventuresDeleteDelete: (
			data: DeleteAdventureInputDTO,
			params: RequestParams = {}
		) =>
			this.request<SuccessDTO, HTTPValidationError>({
		 ...
		 * @secure
		 */
		updateAdventuresUpdatePut: (
			data: UpdateAdventureInputDTO,
			params: RequestParams = {}
		) =>
			this.request<AdventureDTO, HTTPValidationError>({
	...
	threads = {
		 ...
		 * @secure
		 */
		createThreadsCreatePost: (
			data: CreateThreadInputDTO,
			params: RequestParams = {}
		) =>
			this.request<ThreadDTO, HTTPValidationError>({
				path: `/threads/create/`,
		 ...
		 * @secure
		 */
		deleteThreadsDeleteDelete: (
			data: DeleteThreadInputDTO,
			params: RequestParams = {}
		) =>
			this.request<SuccessDTO, HTTPValidationError>({
				path: `/threads/delete/`,
		 ...
		 * @secure
		 */
		updateThreadsUpdatePut: (
			data: UpdateThreadInputDTO,
			params: RequestParams = {}
		) =>
			this.request<ThreadDTO, HTTPValidationError>({
				path: `/threads/update/`,
	...
	posts = {
		 ...
		 * @secure
		 */
		deletePostsDeleteDelete: (
			data: DeletePostInputDTO,
			params: RequestParams = {}
		) =>
			this.request<SuccessDTO, HTTPValidationError>({
				path: `/posts/delete/`,
	...
	media = {
		 ...
		 * @secure
		 */
		uploadMediaUploadPost: (
			data: BodyUploadMediaUploadPost,
			params: RequestParams = {}
		) =>
