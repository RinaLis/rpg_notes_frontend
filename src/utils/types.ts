...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  auth = {
     ...
     */
    passwordResetAuthPasswordResetPost: (data: RecoveryPasswordInputDTO, params: RequestParams = {}) =>
      this.request<TokensOutputDTO, HTTPValidationError>({
  ...
  adventures = {
     ...
     * @secure
     */
    deletePlayerAdventuresDeletePlayerPost: (data: DeletePlayerInputDTO, params: RequestParams = {}) =>
      this.request<PlayersByAdventureOutputDTO, HTTPValidationError>({
