...
import { UserDTO } from 'src/utils/api-client';
...
export const requestLoginUser = createAsyncThunk('user/login', loginUserApi);
...
export const requestGetUser = createAsyncThunk('user/getByToken', getUserApi);
